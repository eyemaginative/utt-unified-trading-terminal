...
export default function MarketCapWindow({ apiBase }) {
    ...
    <div style={ui.wrap}>
      <div style={ui.header}>
        <div>
          ...
          <div style={ui.sub}>Top 250 market cap currencies (scaffold).</div>
        </div>
      ...
      <div style={ui.body}>
        <div style={ui.card}>
          ...
          <div style={{ fontSize: 12, opacity: 0.85, ...ui.mono }}>
            ...
            <br />- Endpoint: TBD (e.g. /api/scanners/market_cap?limit=250)
            <br />- Output: rank, asset, market cap, price, 24h change, etc.
          </div>
